...
class SyncTexJs {
    ...
    parseSyncTexForPdf(pdfFile) {
        ...
        throw new synctexjs_1.SyncTexJsError(`parseSyncTexForPdf failed with: ${pdfFile}`);
    }
    ...
    syncTexJsForward(line, filePath, pdfFile) {
        ...
        if (inputFilePath === undefined) {
            ...
            throw new synctexjs_1.SyncTexJsError(`[SyncTexJs] No relevant entry of the tex file found in the synctex file: ${JSON.stringify({ filePath, pdfFile, line, inputFilesStr })}`);
        }
