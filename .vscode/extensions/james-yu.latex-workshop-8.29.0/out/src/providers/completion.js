...
class Completer {
    constructor(extension) {
        ...
        this.import = new input_1.Import(extension);
        this.subImport = new input_1.SubImport(extension);
...
class AtSuggestionCompleter {
    constructor(extension) {
        ...
        this.atSuggestion = new atsuggestion_1.AtSuggestion(extension, triggerCharacter);
