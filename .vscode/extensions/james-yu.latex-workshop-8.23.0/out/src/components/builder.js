...
class Builder {
    ...
    async buildWithExternalCommand(command, args, pwd, rootFile = undefined) {
        ...
        const wd = (workspaceFolder === null || workspaceFolder === void 0 ? void 0 : workspaceFolder.uri.fsPath) || pwd;
        ...
        if (recipeName === undefined && magicTex && !configuration.get('latex.build.forceRecipeUsage')) {
            ...
            recipe.tools.forEach(tool => {
                if (typeof tool === 'string') {
                    ...
                    if (candidates.length < 1) {
                        this.extension.logger.addLogMessage(`Skipping undefined tool: ${tool} in ${recipe === null || recipe === void 0 ? void 0 : recipe.name}`);
                        void this.extension.logger.showErrorMessage(`Skipping undefined tool "${tool}" in recipe "${recipe === null || recipe === void 0 ? void 0 : recipe.name}."`);
                    }
                    else {
